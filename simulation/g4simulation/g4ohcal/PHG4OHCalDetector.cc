...
int PHG4OHCalDetector::ConstructOHCal(G4LogicalVolume *hcalenvelope)
{
  ...
  m_DisplayAction->AddRing1Volume(reader->GetVolume("RingSupport_steel_1"));
  ...
  m_DisplayAction->AddRing2Volume(reader->GetVolume("RingSupport_steel_2"));
  ...
  m_DisplayAction->AddRing3Volume(reader->GetVolume("RingSupport_alum_1"));
  ...
  m_DisplayAction->AddRing4Volume(reader->GetVolume("RingSupport_alum_2"));
  ...
  m_DisplayAction->AddRing5Volume(reader->GetVolume("HCalRing_alum_1"));
  ...
  m_DisplayAction->AddRing6Volume(reader->GetVolume("HCalRing_alum_2"));
